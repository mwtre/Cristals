-- Run this in Supabase SQL Editor to create the factory_areas table for the Factory Map app.
...
-- Seed areas matching the floor plan (Expedition, Receiving, Inventory, Digital printer x2, Sandblasting, Rack)
